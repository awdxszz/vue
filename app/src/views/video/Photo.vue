...
.sub{width: calc(100% - 20px); margin: 0 auto; text-align: center; padding: 15px 0; background: #4a4c5b; color: #4CB4E7; border-radius: 5px;}
.sub:active{background-color: #4CB4E7;}
</style>
